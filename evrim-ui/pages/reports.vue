...
<div class="bg-surface-50 dark:bg-surface-950 p-6">
    <div class="text-surface-900 dark:text-surface-0 font-medium text-xl mb-4 pl-2">Reports</div>
        ...
        <div class="grid grid-cols-12 gap-4">
            <div v-for="task in tasks" :key="task.task_id" class="col-span-12 md:col-span-6 xl:col-span-4 p-4 pl-2">
                <div class="bg-surface-0 dark:bg-surface-900 shadow rounded-border p-4 border border-surface hover:border-surface-300 dark:hover:border-surface-500">
                    <div class="flex border-b border-surface pb-4">
                        <div class="flex flex-col items-start">
                            ...
                            <span v-if="task.status === 'P'" class="bg-blue-50 text-blue-400 dark:bg-blue-500/30 dark:text-blue-200 rounded-border inline-flex py-1 px-2 text-sm mb-2">
                            Pending
                            </span>
                            <span v-if="task.status === 'R'" class="bg-purple-50 text-blue-400 dark:bg-purple-500/30 dark:text-purple-200 rounded-border inline-flex py-1 px-2 text-sm">
                            Running
                            </span>
